...
class ConditionalStopIfTrueTest extends AbstractFunctional
{
    ...
    public function testConditionalStopIfTrue($format)
    {
        ...
        $condition0 = new \Wya\PhpSpreadsheet\Style\Conditional();
        $condition0->setConditionType(\Wya\PhpSpreadsheet\Style\Conditional::CONDITION_EXPRESSION);
        ...
        $condition1 = new \Wya\PhpSpreadsheet\Style\Conditional();
        $condition1->setConditionType(\Wya\PhpSpreadsheet\Style\Conditional::CONDITION_CELLIS);
        $condition1->setOperatorType(\Wya\PhpSpreadsheet\Style\Conditional::OPERATOR_LESSTHAN);
        ...
        $condition2 = new \Wya\PhpSpreadsheet\Style\Conditional();
        $condition2->setConditionType(\Wya\PhpSpreadsheet\Style\Conditional::CONDITION_CELLIS);
        $condition2->setOperatorType(\Wya\PhpSpreadsheet\Style\Conditional::OPERATOR_GREATERTHAN);
